ERR_TOKEN_MULTILINE_COMMENTS_NOT_CLOSED = SyntaxError(
    "Multiline comments should be closed"
)
ERR_TOKEN_UNKNOWN = ValueError("Token cant be parsed")
ERR_TOKEN_BAD_SYMBOL = ValueError("Newline in string constant")
